...
- "Conservation of the postulate": square not derivable from consistency (counterexample),
  fixed by causality — postulate relocates, does not vanish.
- (Area/dimensional hypothesis is deferred to §7 as [conjecture].)

## Sources
- ribbon_model_note.md §2.4–2.6 (chord law, causality, uniqueness p=2), §2.7
  ("postulate conservation").
- Commits: born.py, born2.py (q=0.85, Δ=0.0717), chord.py (session 3).
